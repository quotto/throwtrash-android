...
//    }
  ...
  @Test
  fun if_trashes_is_not_empty_and_matches_trash_day_then_trashes_is_set() {
    val trash1 = Trash("id1", TrashType.BURN, "burnable", listOf(WeeklySchedule(DayOfWeek.SUNDAY)), listOf())
    val trash2 = Trash("id2", TrashType.UNBURN, "unburnable", listOf(WeeklySchedule(DayOfWeek.SUNDAY)), listOf())
//    val expectedCalendarDayList = listOf(
//      CalendarDay(2024,9,1, DayOfWeek.SUNDAY,listOf(trash1,trash2)),
//      CalendarDay(2024,9,2, DayOfWeek.MONDAY,listOf()),
//      CalendarDay(2024,9,3, DayOfWeek.TUESDAY,listOf()),
//      CalendarDay(2024,9,4, DayOfWeek.WEDNESDAY,listOf()),
//      CalendarDay(2024,9,5, DayOfWeek.THURSDAY,listOf()),
//      CalendarDay(2024,9,6, DayOfWeek.FRIDAY,listOf()),
//      CalendarDay(2024,9,7, DayOfWeek.SATURDAY,listOf()),
//      CalendarDay(2024,9,8, DayOfWeek.SUNDAY,listOf(trash1,trash2)),
//      CalendarDay(2024,9,9, DayOfWeek.MONDAY,listOf()),
//      CalendarDay(2024,9,10, DayOfWeek.TUESDAY,listOf()),
//      CalendarDay(2024,9,11, DayOfWeek.WEDNESDAY,listOf()),
//      CalendarDay(2024,9,12, DayOfWeek.THURSDAY,listOf()),
//      CalendarDay(2024,9,13, DayOfWeek.FRIDAY,listOf()),
//      CalendarDay(2024,9,14, DayOfWeek.SATURDAY,listOf()),
//      CalendarDay(2024,9,15, DayOfWeek.SUNDAY,listOf(trash1,trash2)),
//      CalendarDay(2024,9,16, DayOfWeek.MONDAY,listOf()),
//      CalendarDay(2024,9,17, DayOfWeek.TUESDAY,listOf()),
//      CalendarDay(2024,9,18, DayOfWeek.WEDNESDAY,listOf()),
//      CalendarDay(2024,9,19, DayOfWeek.THURSDAY,listOf()),
//      CalendarDay(2024,9,20, DayOfWeek.FRIDAY,listOf()),
//      CalendarDay(2024,9,21, DayOfWeek.SATURDAY,listOf()),
//      CalendarDay(2024,9,22, DayOfWeek.SUNDAY,listOf(trash1,trash2)),
//      CalendarDay(2024,9,23, DayOfWeek.MONDAY,listOf()),
//      CalendarDay(2024,9,24, DayOfWeek.TUESDAY,listOf()),
//      CalendarDay(2024,9,25, DayOfWeek.WEDNESDAY,listOf()),
//      CalendarDay(2024,9,26, DayOfWeek.THURSDAY,listOf()),
//      CalendarDay(2024,9,27, DayOfWeek.FRIDAY,listOf()),
//      CalendarDay(2024,9,28, DayOfWeek.SATURDAY,listOf()),
//      CalendarDay(2024,9,29, DayOfWeek.SUNDAY,listOf(trash1,trash2)),
//      CalendarDay(2024,9,30, DayOfWeek.MONDAY,listOf()),
//      CalendarDay(2024,10,1, DayOfWeek.TUESDAY,listOf()),
//      CalendarDay(2024,10,2, DayOfWeek.WEDNESDAY,listOf()),
//      CalendarDay(2024,10,3, DayOfWeek.THURSDAY,listOf()),
//      CalendarDay(2024,10,4, DayOfWeek.FRIDAY,listOf()),
//      CalendarDay(2024,10,5, DayOfWeek.SATURDAY,listOf()),
//    )
//    val fiveWeeksCalendar = FiveWeeksCalendar(2024, 9, listOf(trash1, trash2))
//
//    val calendarDayList = fiveWeeksCalendar.getCalendarDayList()
//
//    calendarDayList.forEachIndexed { index, calendarDay ->
//      if ( index == 0 || index == 7 || index == 14 || index == 21 || index == 28) {
//        Assertions.assertEquals(2, calendarDay.getTrashes().size)
//      } else {
//        Assertions.assertEquals(0, calendarDay.getTrashes().size)
//      }
//    }
  }
}