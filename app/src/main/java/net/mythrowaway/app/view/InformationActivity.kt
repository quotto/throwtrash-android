...
import net.mythrowaway.app.adapter.controller.InformationController
...
class InformationActivity : AppCompatActivity(), IInformationView {
    @Inject
    lateinit var controller: InformationController
    @Inject
    lateinit var presenter: IInformationPresenter
