...
import com.example.mythrowtrash.adapter.ActivateControllerImpl
import com.example.mythrowtrash.adapter.IActivateView
...
class ActivateActivity : AppCompatActivity(),IActivateView,CoroutineScope by MainScope() {
    ...
    private val controller = ActivateControllerImpl(this)
