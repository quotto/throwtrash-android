...
class MainActivity : AppCompatActivity(), ViewPager.OnPageChangeListener,CalendarFragment.FragmentListener,ICalendarView,CoroutineScope by MainScope() {
    ...
    override fun onPageScrollStateChanged(state: Int) {
        if(state == ViewPager.SCROLL_STATE_IDLE) {
            println("[PagerDemo]scrolled page: ${calendarPager.currentItem}")
